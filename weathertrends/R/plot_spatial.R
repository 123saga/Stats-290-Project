...
plot_spatial <- function(online=TRUE,Date=as.Date("2017-01-01"), measure="t_max") {
  ...
  out <- tryCatch({
    ...
    return((paste0("ERROR While using Google Maps API, please re-try again after sometime")))
